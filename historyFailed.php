...
<div class="container">
  ...
  <li>
    <a href="history.php">Successful Deals</a>
  </li>

  <li class="active">
    <a href="#">Failed Deals</a>
  </li>
</ul>
</div>
<?php
...
<?php
  ...
  //checking if the date of the deals is valid or not
	...
	for ($i=0;$i<count($dealIds);$i++){
		$dealId = $dealIds[$i];
		$sql = "SELECT * FROM {$p}deal where deal_id = '{$dealId}'";
...
?>
 ...
 <div class="row" id="tabledata">
  ...
  <div class="row">Requested for: <?php echo($row['deal_nature']);?>    </div>
  <div class="row">Ended on: <?php echo($row['deal_end']);?>   </div>
   </div>
   <div class="col-md-4">
    <div class=row>
      <div class="col-md-4">
